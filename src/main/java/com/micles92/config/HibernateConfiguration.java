...
@EnableJpaRepositories(basePackages = "com.micles.dao")
public class HibernateConfiguration {
    ...
    public EntityManagerFactory entityManagerFactory(){
        ...
        factoryBean.afterPropertiesSet(); //sprawdza ustawione propertisy
    ...
    @Bean
    public PlatformTransactionManager transactionManager(){  //zarzadzanie transakcyjnoscia od strony Springa
